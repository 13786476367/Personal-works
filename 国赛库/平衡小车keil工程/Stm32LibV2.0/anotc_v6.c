...
//写一个字节
static __INLINE void ANOTC_WriteByte(pANOTC obj,uint8_t *dat)
{
	obj->buff[obj->size++]=*dat;
}

//写两个字节
static __INLINE void ANOTC_WriteWord(pANOTC obj,uint16_t *dat)
{
...
//写四个字节
static __INLINE void ANOTC_WriteDWord(pANOTC obj,uint32_t *dat)
{
